...
const OnlyContainer = () => {
  return (
    <div className="ml-[32px] mt-[5rem] sm:ml-4 sm:mt-[3rem]">
      ...
      <p className="text-2xl mt-4 animate-slide-in-from-top sm:text-xl sm:mt-6 md:text-2xl">
        미래에셋센터원에서 경험하는{" "}
      ...
      <div className="flex gap-6 mt-10 flex-col sm:flex-row sm:flex-wrap sm:gap-4 sm:mt-6 sm:justify-center">
        ...
        <div className="max-w-sm w-full rounded-lg shadow group relative transition duration-1000 ease-in-out hover:scale-105">
          ...
          <div className="mt-10 sm:mt-6">
            <h5 className="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white group-hover:text-[#F58220] sm:text-2xl">
              프라임 서비스
            </h5>
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 sm:text-sm">
